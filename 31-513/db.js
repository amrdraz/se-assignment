...
var _db = null;
var dbUrl = 'mongodb://localhost:27017/quotesApp';

var quote = {
    "header": "header retrieved from DB",
    "content": "content retrieved from DB"
};
...
var DB = {
     seed: function seed(cb) {
        DB.clear(function(err) {
            ...
            DB.db().collection('post').insert(quote, function(err, result) {
                assert.equal(null, err);
