	...
	$.ajax({
		...
		success: function(quote){
			...
			switch(index)
			{
				...
				break;
				case 2:document.body.style.backgroundImage="url('http://3.bp.blogspot.com/-28Tz2V0ZqL8/UQVhscN4eFI/AAAAAAAAC0o/b3Aa_-ApKNM/s1600/mooi-landschap-met-meer-en-bomen.jpeg')";
				break;
				case 3:document.body.style.backgroundImage="url('http://wallpaperry.com/sites/default/files/styles/2880x1800/public/images/orig//735%20-%20uV8KBzR.jpg?itok=7ABKuD9L')";
				break;
				case 4:document.body.style.backgroundImage="url('http://wallpapercave.com/wp/VrmXlXD.jpg')";
				break;
				
				case 5:document.body.style.backgroundImage="url('http://escolha-vencer.com/wp-content/uploads/2015/04/relaxing_sea_swing-1572989.jpg')";
				break;
				case 6:document.body.style.backgroundImage="url('http://indulgence-hair-salon.com/wp-content/themes/newace6/images/mine/Background-Image4.jpg')";
				break;
				//case 7:document.body.style.backgroundImage="url('https://i.ytimg.com/vi/GgH-uXC-Qmk/maxresdefault.jpg')";
				//break;
				case 7:document.body.style.backgroundImage="url('http://1.bp.blogspot.com/-kM1HWvB8i9g/T_MJYJenGGI/AAAAAAAAEFY/4NHIy67ccZ4/s1600/Waterfall-4-XOVYYPSKDW-1280x1024.jpg')";
				break;
				...
				//break;
				case 8:document.body.style.backgroundImage="url('http://www.desktopaper.com/wp-content/uploads/l/exclusive-hd-wallpaper-of-nature-background.jpg')";
				break;
				//case 11:document.body.style.backgroundImage="url('http://www.designsnext.com/wp-content/uploads/2014/04/Nature-HD-Background-6.jpg')";
				//break;
