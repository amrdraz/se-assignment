...
describe("getQuotesFromJSON", function() {
 ...
 var res = Quote.getQuotesFromJSON();
 assert.equal(res[0].author,"Kevin Kruse");
 });
});
 ...
 var json = Quote.getQuotesFromJSON();
 var flag=false;
 ...
 request.get("/zizo").set("Accept","text/html").expect(404).end(function(err,res){
 done();
 });
 });
